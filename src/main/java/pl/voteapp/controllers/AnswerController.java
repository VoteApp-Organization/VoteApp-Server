...
import pl.voteapp.AnswerList;
import pl.voteapp.AnswerWrapper;
...
public class AnswerController {
    ...
    @ResponseBody
    public ResponseEntity<Object> saveUserAnswers(@RequestBody AnswerList answers) {
        List<Answer> answerList = answers.getCosTam();
